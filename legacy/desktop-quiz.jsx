// Quiz form for desktop — Icon comes from window.Icon
const { useState: useStateQ } = React;

function QuizForm({ onClose }) {
    ...
    <>
      ...
      <div className="quiz-foot">
        ...
        <button
          ...
          onClick={next}
        >
          {step === 3 ? 'Quero simular agora' : 'Continuar'} <window.Icon.Arrow width="16" height="16"/>
        </button>
      </div>
    </>
  );
