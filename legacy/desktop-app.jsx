// Main desktop app — uses window.Icon and window.QuizForm
        ...
        <div>
          ...
          <div className="hero-actions">
            <button className="btn btn-red" onClick={onCta}>
              Simular meu consórcio <window.Icon.Arrow width="18" height="18" />
            </button>
...
function Produtos({ onPick }) {
  const items = [
  { num: '01', title: 'Imóveis', icon: <window.Icon.Home width="24" height="24" />, meta: 'Casa, apartamento, terreno ou construção do seu jeito.', list: ['Cartas de R$ 80mil a R$ 1.5mi', 'Use o FGTS no lance', 'Prazos de até 200 meses'] },
  { num: '02', title: 'Veículos', icon: <window.Icon.Car width="24" height="24" />, meta: 'Carros 0km, seminovos e motos. Sem entrada.', list: ['Cartas de R$ 30mil a R$ 250mil', 'Negocie como pagamento à vista', 'Prazos de até 100 meses'] },
  { num: '03', title: 'Pesados & Serviços', icon: <window.Icon.Truck width="24" height="24" />, meta: 'Caminhões, máquinas, motos e reformas.', list: ['Cartas para frota e maquinário', 'Capital de giro para o seu negócio', 'Reforma e construção'] }];
      ...
      <div className="wrap">
        ...
        <div className="products-grid">
          ...
          <div key={it.num} className="product-card" onClick={onPick}>
              ...
              <div className="product-cta">Ver planos <window.Icon.Arrow width="14" height="14" /></div>
            </div>
          )}
        </div>
      </div>
        ...
        <div className="sim-side">
          ...
          <div className="sim-features">
            <div className="sim-feature">
              <div className="sim-feature-icon"><window.Icon.Clock width="18" height="18" /></div>
              <div>
            ...
            <div className="sim-feature">
              <div className="sim-feature-icon"><window.Icon.Shield width="18" height="18" /></div>
              <div>
            ...
            <div className="sim-feature">
              <div className="sim-feature-icon"><window.Icon.Sparkles width="18" height="18" /></div>
              <div>
    ...
    <section className="section s-compare">
      <div className="wrap">
        ...
        <div className="compare-amount">
          <window.Icon.Home className="" width="18" height="18" />
          <div>
        ...
        <div className="faq-side">
          ...
          <div className="faq-help">
            ...
            <button className="btn btn-red" style={{ padding: '12px 22px', fontSize: '14px' }} onClick={onCta}>
              <window.Icon.Wpp width="16" height="16" /> Falar com especialista
            </button>
          </div>
        </div>
          ...
          <div className="cta-card-content">
            ...
            <div className="cta-card-actions">
              <button className="btn btn-light" onClick={onCta}>
                <window.Icon.Wpp width="18" height="18" /> Falar no WhatsApp
              </button>
              <a href="tel:+551297444005" className="btn btn-ghost">
                <window.Icon.Phone width="16" height="16" /> Receber uma ligação
              </a>
            </div>
          </div>
          <div className="cta-info">
            <div className="cta-info-row">
              <div className="cta-info-icon"><window.Icon.Phone width="18" height="18" /></div>
              <div>
            ...
            <div className="cta-info-row">
              <div className="cta-info-icon"><window.Icon.Pin width="18" height="18" /></div>
              <div>
            ...
            <div className="cta-info-row">
              <div className="cta-info-icon"><window.Icon.Clock width="18" height="18" /></div>
              <div>
        ...
        <div className="footer-grid">
          <div className="footer-col">
            ...
            <div className="footer-social">
              <a href="#" aria-label="Instagram"><window.Icon.IG width="18" height="18" /></a>
              <a href="#" aria-label="Facebook"><window.Icon.FB width="18" height="18" /></a>
              <a href="#" aria-label="LinkedIn"><window.Icon.LI width="18" height="18" /></a>
              <a href="#" aria-label="WhatsApp"><window.Icon.Wpp width="18" height="18" /></a>
            </div>
          </div>
          <div className="footer-col">
          ...
          <div className="footer-col">
            ...
            <ul>
              <li><div className="footer-cert"><window.Icon.Shield width="16" height="16" /> Regulado pelo BACEN</div></li>
              <li><div className="footer-cert"><window.Icon.Shield width="16" height="16" /> Lei 11.795/2008</div></li>
  ...
  return (
    <div className="quiz-modal-backdrop" onClick={onClose}>
      <div className="quiz-modal" onClick={(e) => e.stopPropagation()}>
        ...
        <window.QuizForm onClose={onClose} />
      </div>
    </div>);
  ...
  return (
    <>
      ...
      <button className="fab" aria-label="WhatsApp" onClick={openQuiz}>
        <window.Icon.Wpp width="26" height="26" />
      </button>
